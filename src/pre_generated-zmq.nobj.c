...
"\n"
"-- method: init_data\n"
"function _pub.zmq_msg_t.init_data(data1, data_len1)\n"
"  data_len1 = data_len1 or #data1\n"
"  local self = ffi.new(\"zmq_msg_t\")\n"
"  local err2 = 0\n"
...
"\n"
"-- method: set_data\n"
"function _meth.zmq_msg_t.set_data(self, data2, data_len2)\n"
"  \n"
"  data_len2 = data_len2 or #data2\n"
"  local err1 = 0\n"
